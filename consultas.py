...
def email_birthdate():
	#Muestra id, email y birthdate de los usuarios nacidos entre la fecha from y to(ambas incluidas) Mostrar tabla con 3 columnas, num encontrados
	#Cogemos los datos
	fechaInicio = request.query.fro 
	...
	#Numero de datos encontrados
 	contador = 0
        for elem in result:
		contador = contador + 1
	print("El numero de elementos encontrados es: ", contador)
	for elem in result:
   		print(elem['_id'], elem['email'], elem['birthdate'])
